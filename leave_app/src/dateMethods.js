...
const dateCalculatorExcludeWeekendNoCurrentMonth = (startDate, endDate) => {
    let holidays = [
        "2022-01-01",
        "2023-01-23",
        "2023-01-24",
...
export {dateCalculatorExcludeWeekendNoCurrentMonth, dateCalculatorExcludeWeekend, getFirstAndLastDay}